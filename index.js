        ...
        try {
            ...
            Promise.all(promises)
                ...
                .then(allLinks => { // consumo de promesa
                    console.log(allLinks.flat()); // flat es para crear un solo array que contenga todos los array como objetos //AQUI IRIA EL RESOLVE!! porque tiene que devolver los links
                })
                .catch(err => {
                    console.error(err.message); //AQUI IRIA EL REJECT!! porque aqui termina la función
                });
